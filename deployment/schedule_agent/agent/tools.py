...
def create_schedule_tools(data_store: DataStore):
    ...
    def create_schedule(target_date: str) -> Dict[str, Any]:
        """Execute complete scheduling workflow using files already loaded in DataStore.
        ...
        """
        # Files are already loaded in DataStore, just run the pipeline
        schedule = pipeline.full_pipeline(target_date)
    ...
    def show_schedule_summary() -> Dict[str, Any]:
        ...
        return {
            ...
            "unscheduled_patients": len(data_store.load_schedule().unscheduled_patients),
